...
init_path = os.path.join('kore_plugins_flask', '__init__.py')
...
entry_points = """\
[kore.components]
kore.components.flask =\
    kore_plugins_flask.plugins.application:FlaskApplicationPluginComponent
"""


setup(
    name='kore-plugins-flask',
    version=metadata['version'],
    author=metadata['author'],
    author_email=metadata['email'],
    url=metadata['url'],
    packages=find_packages(include=('kore_plugins_flask*',)),
